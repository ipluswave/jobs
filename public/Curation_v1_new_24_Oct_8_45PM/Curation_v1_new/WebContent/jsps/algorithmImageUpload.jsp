...
<title>Register Algorithm</title>
<!-- Bootstrap -->
<link
...
<body>
	<div id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<form:form class="form-horizontal" action="addAlgorithmImage"
				method="post" name="dataSourceForm" id="dataSourceForm"
						...
						<div class="col-lg-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="box-panel">
										<div class="box-body">
											<h3 class="box-heading remove">Upload R-script</h3>
											<br>
											<div class="tab-content row">
												<div role="tabpanel"
													class="tab-pane active col-lg-6 col-lg-offset-1" id="home">

													<div class="form-group">
														<input type="file" name="doc"
															class="form-control input-lg" id="inputFile"
															placeholder="Select file" accept=".R,.r"
															required="required">
													</div>
													<div class="form-group">
														<label for="name" class="sr-only">Name</label> <select
															name="algorithmSource" id="algorithmSource"
