            ...
            <div class="container-fluid">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-4 text-center">
                                        <img src="resources/images/avatar.jpg" alt="avatar" class="img-circle img-responsive">
                                    ...
                                    <div class="col-md-8">
                                        <form>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="desc" class="form-control input-lg" rows="5" cols="4" placeholder="Enter Description"></textarea>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered" id="appendhere">
                                        <tbody>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <button class="btn btn-navy btn-lg" onclick="updateUser()">&nbsp;&nbsp;&nbsp;<i class="fa fa-download"></i>&nbsp;&nbsp;save curator detail&nbsp;&nbsp;&nbsp;&nbsp;</button>
                    </div>
                </div>
                <br>
            </div>
...
function updateUser() {
  ...
  "async": true,
  "crossDomain": true,
  "url": "http://catalog-api-dev.elasticbeanstalk.com/users/"+userid,
  "method": "PUT",
  "xhrFields": {
			        "withCredentials": true
			    },
...
$.ajax(settings).done(function (response) {
  ...
  for(i=0; i<data.length; i++)
  {
	...
	$("#appendhere").append('<tr><td><div class="checkbox"><input id="check1" type="checkbox" name="check" value="check1"><label for="check1"></label></div></td><td><a href="#" class="product"><span class="product-img"><img alt="" src="'+data[i].image+'" width="50"></span><ul class="list-unstyled"><li><span class="product-name">'+data[i].name+'</span></li><li><span class="product-cat">'+data[i].layout+'</span></li></ul></a></td><td><ul class="list-inline pull-right"><li><a class="btn btn-white btn-lg" href="editcatalog.html?editId='+data[i].id+'"><i class="fa fa-pencil fa-lg"></i></a></li><li><button class="btn btn-white btn-lg remove" onclick="deletecatalog('+data[i].id+')"><i class="fa fa-times fa-lg"></i></button></li></ul></td></tr>');
...
function getuserData(){
		  ...
		  $.ajax(getuserId).done(function (response) {
			...
			document.getElementById('desc').value = dt.profile_description;
