            ...
            <div class="container-fluid">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills">
                                    ...
                                    <li role="presentation" class="active"><a href="#"><i class="sprites sprite-pro"></i><br>promoted</a></li>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <button class="btn btn-navy btn-lg" id="addData" onclick="addPromotedObject()">&nbsp;&nbsp;&nbsp;<i class="fa fa-download"></i>&nbsp;&nbsp;save catalog detail&nbsp;&nbsp;&nbsp;&nbsp;</button>
                    </div>
                </div>
                <br>
            </div>
...
$.ajax(addObj).done(function (response) {
 ...
 alert("\"Promoted Object created Successfully.\"");
	$('#objecttitle').val("");
