...
-->
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <button class="btn btn-navy btn-lg" onclick="updateObject()">&nbsp;&nbsp;&nbsp;<i class="fa fa-download"></i>&nbsp;&nbsp;save catalog detail&nbsp;&nbsp;&nbsp;&nbsp;</button>
                    </div>
                </div>
                <br>
            </div>
...
/*
function addobject(tk,userid) {

alert("inside addobject("+tk+","+userid + ")");
...
type =typ;
  ...
  "async": true,
  "crossDomain": true,
  "url": "http://catalog-api-dev.elasticbeanstalk.com/objects/{id}/catalog?category="+category+"&type="+type+"&name="+name+"&description="+desc+"&url="+fileUrl+"&curated=True&author="+userid+"&_token="+tk,
  "method": "POST",
  "xhrFields": {
  ...
  "async": true,
  "crossDomain": true,
  "url": "http://catalog-api-dev.elasticbeanstalk.com/objects?category="+category+"&type="+type+"&name="+name+"&description="+desc+"&url="+fileName+"&curated=True&author="+userid+"&_token="+tk,
  "method": "POST",
  "xhrFields": {
			        "withCredentials": true
			    },
  ...
  "async": true,
  "crossDomain": true,
  "url": "http://catalog-api-dev.elasticbeanstalk.com/objects?category="+category+"&type="+type+"&name="+name+"&description="+desc+"&curated=True&author="+userid+"&_token="+tk,
  "method": "POST",
  "xhrFields": {
			        "withCredentials": true
			    },
...
function drptypechange()
{
  ...
  "data": {
	...
	$.ajax(bindCatalogArr).done(function (response) {
			...
			$("#ddlcategory").html("");
			var dropdown_data="";
			dropdown_data = "<option value='0'>-Select Catalogs-</option>";
...
function bindObject() {
	 var bindObjectArr = {
	  "async": true,
	  "crossDomain": true,
	  "url": "http://catalog-api-dev.elasticbeanstalk.com/search/objects",
	  "method": "POST",
	  "xhrFields": {
			        "withCredentials": true
			    },"headers": {
	...
	$.ajax(bindObjectArr).done(function (response) {
			var dt = response.content.data;
			var i;
			$("#ddltype").html("");
			var dropdown_data="";
			dropdown_data = "<option value='0'>-Select Object-</option>";
	...
	// UPDATE OBJECT DETAILS OR ADDING OBJECT TO SELECTED CATALOGS
	...
	var e2 = document.getElementById("ddltype");
	var cat1 = e2.options[e2.selectedIndex].value;
	
	var addObj = {
  "async": true,
  "crossDomain": true,
  "url": "http://catalog-api-dev.elasticbeanstalk.com/objects/"+cat1,
  "data" : {
	"catalog_id" : cat
	},
  "method": "PUT",
