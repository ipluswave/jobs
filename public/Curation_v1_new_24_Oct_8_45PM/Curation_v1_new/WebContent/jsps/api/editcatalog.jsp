            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <button class="btn btn-navy btn-lg" onclick="updatecatalog()">&nbsp;&nbsp;&nbsp;<i class="fa fa-download"></i>&nbsp;&nbsp;save catalog detail&nbsp;&nbsp;&nbsp;&nbsp;</button>
                    </div>
                </div>
                <br>
            </div>
...
function updatecatalog() {
  ...
  "async": true,
  "crossDomain": true,
  "url": "http://catalog-api-dev.elasticbeanstalk.com/catalogs/"+t[1],
  "method": "PUT",
...
$.ajax(addCat).done(function (response) {
  console.log(response);
	...
	document.getElementById("filetxtbox").value == "";
...
function getCatalog(){
	...
	var e = document.getElementById("ddlcategory");
	var fileName = document.getElementById("filetxtbox");
	var fileUrl = document.getElementById("filetitle");
	
	 var dt = response.content;
	   
	title.value = dt.title;
	name.value = dt.name;
	e.value = dt.category_id;
	fileName.value = dt.image;
	fileUrl.src = dt.image;
