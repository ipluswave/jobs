...
<body>
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <form:form action="addAlgorithm" method="post" modelAttribute="algorithm" class="form-horizontal">
            	<div class="container-fluid">
	                <div class="row">
	                    <div class="col-lg-12">
	                        <div class="panel panel-default">
	                            ...
	                            <div class="panel-body">
	                               	<div class="form-group">
	                            		<label for="algorithmType" class="col-sm-2 control-label">Attribute Type</label>
	                            		<div class="col-sm-10">
	                            			<form:select path="algorithmTypeId" class="form-control input-lg" required="required">
	                                   ...
	                                   <div class="form-group">
	                                       <label for="title" class="col-sm-2 control-label">Attribute Name</label>
	                                       <div class="col-sm-10">
	                                       		<form:input path="algorithmName" class="form-control input-lg" id="algorithmName" placeholder="Enter Attribute Name" required="required"/>
	                                       </div>
	                                   </div>
	                                   <div class="form-group">
	                                       <div class="col-sm-12">
	                                       		<form:textarea path="description" class="form-control input-lg" rows="3" cols="4" placeholder="Description of Algorithm:" required="required"/>
	                                       </div>
	                                   </div>
	                                   <div class="form-group">
	                                       <div class="col-sm-12">
	                                           <form:input path="usage" class="form-control input-lg" id="title" placeholder="Where used:" required="required"/>
	                                       </div>
	                                   </div>
	                                   <div class="form-group">
	                                       <div class="col-sm-12">
	                                           <form:input path="tags" class="form-control input-lg" id="title" placeholder="Tags:" required="required"/>
	                                       </div>
	                                   </div>
	                            </div>
	                        </div>
	                        ...
	                        <div class="panel panel-default">
	                            <div class="panel-body">
	                                <div class="text-right">
	                                    <form:button class="btn btn-navy btn-lg">&nbsp;&nbsp;&nbsp;Next&nbsp;<i class="fa fa-chevron-right"></i>&nbsp;&nbsp;&nbsp;</form:button>
	                                </div>
	                            </div>
	                        </div>
	                    </div>
    ...
    <script src="<%=request.getContextPath()%>/resources/controller/algorithmController.js"></script>
</body>
</html>