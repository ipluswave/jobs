...
<body>
			...
			<div class="container-fluid">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<ul class="list-inline">
									<li>
										<h3 class="panel-title">Attribute Parameters</h3>
									</li>
								</ul>
							</div>
						</div>
							...
							<div class="panel-body">
								<div class="form-group">
									<button type="button" class="btn btn-navy btn-sm"
										data-toggle="modal" data-target="#myModa111">
				...
				<div class="col-lg-12">
					<div class="col-md-12 text-center">
						<button id="doneBtn" class="btn btn-navy btn-lg">&nbsp;&nbsp;done&nbsp;&nbsp;</button>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<form action="javascript:;" id="parameterForm" method="post"
					...
					onsubmit="saveParameterInAttribute11()">
					...
					<div class="modal-body">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="algoid" id="algoid" class="form-control"
									required="required">
									<c:forEach items="${algorithmList}" var="algorithmList">
										<option value="${algorithmList.id}">${algorithmList.algorithmName}</option>
									</c:forEach>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="attributeId" id="attributeId" class="form-control"
									...
									<!-- newAlgorithm -->
									<c:forEach items="${attributeList}" var="attributeList">
										<option value="${attributeList.id}"
											${attributeList.id == newAttributeRegistrationModel.id ? 'selected' : ''}>${attributeList.attributeName}</option>
									</c:forEach>
								</select>
							</div>
						</div>
				...
				success : function(data) {
					...
					if(data.length>0){
						...
						for(i=0;i<data.length;i++){
							...
							$("#source_field").find("ul").append('<li class="option-item" data-value="'+data[i].term+'" data-index="'+data[i].id+'">'+data[i].term+'</li>');
						}
	...
	function searchAttributesByTerm22(){
		var term = $("#dropDown").val();
		if(term){
			var result = $.ajax({
				contentType : 'application/json; charset=utf-8',
				type : "POST",
