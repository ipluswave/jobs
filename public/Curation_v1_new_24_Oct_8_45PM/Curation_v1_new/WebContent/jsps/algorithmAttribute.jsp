			...
			<div class="container-fluid">
				...
				<div class="col-lg-12">
					<div class="col-md-12 text-center">
						<button id="finishBtn" class="btn btn-navy btn-lg">
							&nbsp;&nbsp;Finish&nbsp;&nbsp;&nbsp;&nbsp;<i
	...
	<div class="modal fade" id="attributeModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<form action="javascript:;" id="attributeForm" method="post"
					class="form-horizontal" autocomplete="off"
					onsubmit="saveAttributeRegistration()">
					...
					<div class="modal-body">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<%-- <input type="hidden" id="algorithmId" name="algorithmId" class="form-control input-lg" disabled="disabled" value="${algorithm.id}">
							<input class="form-control input-lg" disabled="disabled" value="${algorithm.algorithmName}"> --%>
