...
<body>
                                    ...
                                    <ul class="nav nav-pills nav-wizard">
                                        ...
                                        <li>
                                            <a href="#tab5" data-toggle="tab">
                                                <div class="nav-wedge"></div>
                                                <i class="cus cus-vis-b"></i>&nbsp;vizualization
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <div id="cs-tabs">
                                                        ...
                                                        <!-- Tab panes -->
                                                        <div class="tab-content">
                                                            <div role="tabpanel" class="scroll tab-pane active viz" id="alg">
                                                                <ul class="list-group">
                                                            ...
                                                            <div role="tabpanel" class="scroll tab-pane" id="voc">
                                                                <div class="table-responsive">
                                                                    <table class="table table-striped table-bordered attribute-list">
                                                                        <tbody>
                                                                            <tr>
                                                            ...
                                                            <div role="tabpanel" class="scroll tab-pane viz" id="viz">
                                                                <ul class="list-group">
                                                                    <li class="list-group-item">
                                                                        <ul class="viz-heading">
                                                                            <li>
                                                                            ...
                                                                            <li>
                                                                                <a href="#" class="title">vizualization result 1</a>
                                                                            </li>
                                                                            <li class="pull-right">
                                                                                <a href="#" class="viz-toggle pull-right"><i class="fa fa-chevron-right fa-lg"></i></a>
                                                                            </li>
    ...
    jQuery(document).ready(function($) {
        ...
        $(".scroll").niceScroll({cursorcolor:"#004586",cursoropacitymin: 0.3,cursoropacitymax: 1,cursorborderradius: "5px",cursorwidth: "10px",cursorminheight: 32});
        $('select').comboSelect();
