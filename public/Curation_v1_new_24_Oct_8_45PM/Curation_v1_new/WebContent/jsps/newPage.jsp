                    ...
                    <div class="col-lg-12">
                        <div id="rootwizard">
                                ...
                                <div class="" id="">
                                                ...
                                                <div class="panel-body">
                                                    <div class="tab-content">
                                                        <div class="form-group">
															<label class="col-sm-4 control-label" for="title">Data Source</label>
															<div class="col-sm-10">
															<input id="sourceName" class="form-control input-lg" type="text" required="required" placeholder="<Display data source name here>" name="sourceName">
															</div>
														</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="panel-body">
                                                    <div class="tab-content">
                                                        <div role="tabpanel" class="tab-pane active" id="home">
                                                            <button class="btn btn-white" data-toggle="modal" data-target="#addVocabularyOnNewPage">&nbsp;&nbsp;&nbsp;<i class="fa fa-plus"></i>&nbsp;&nbsp;add vocabulary&nbsp;&nbsp;&nbsp;&nbsp;</button>
                                                            <br/>
                                                            <br/>
                                                            <form>
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control input-lg" id="searchTerm" placeholder="Term">
                                                                    <!-- <small>(Maximum size: 30 MB)</small> -->
                                                                    <br>
                                                                    <button type="button" class="btn btn-navy btn-sm" onclick="searchInTextBox()"><i class="fa fa-search"></i>&nbsp;Browse&nbsp;</button>
                                                                </div>
                                                                <div class="form-group_drop" id="source_field">
                                                                    <label for="name" class="sr-only">Name</label>
                                                                    <select name="dropDown1" id="dropDown1"  class="form-control" onchange="searchAttributesByTerm111()">
                                    ...
                                    <form action="javascript:;" method="post" name="dataFieldForm" id="dataFieldForm" onsubmit="saveUserMappingsNew()">
	                                    <div class="row">
	                                        <div class="col-lg-6">
	                                            <div class="panel panel-default">
	                                            	<div class="panel-heading">
	                                        ...
	                                        <div class="col-md-12 text-center">
						                        <button class="btn btn-navy btn-lg" type="submit">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Next&nbsp;&nbsp;&nbsp;&nbsp;</button>
						                    </div>
	                                    </div>
									</form>
                                </div>
				...
				success : function(data) {
					...
					if(data.length>0){
						...
						for(i=0;i<data.length;i++){
							...
							$(".combo-dropdown").append('<li class="option-item" data-value="'+data[i].term+'" data-index="'+data[i].id+'">'+data[i].term+'</li>');
						}
